      ...
      <div className="mx-auto w-full max-w-6xl px-4 md:px-8">
        ...
        <div className="mt-12 grid gap-6 lg:mt-16 lg:grid-cols-3">
          {promises.map((item, index) => (
            <ScrollReveal key={item.promise} delay={index * 120} className="h-full">
              <article className="flex h-full flex-col justify-between rounded-3xl border border-zinc-200 bg-[#f9f9fb] p-8 transition-shadow hover:shadow-lg">
